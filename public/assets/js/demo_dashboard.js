$(function(){        
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Pulsa", value: 2513},
            {label: "Aksesoris", value: 164},
            {label: "Handphone", value: 21}
        ],
    ...
    Morris.Bar({
        ...
        data: [
            { y: 'Oct 10', a: 175, b: 35, c: 5 },
            { y: 'Oct 11', a: 164, b: 26, c: 6 },
            { y: 'Oct 12', a: 178, b: 39, c: 9 },
            { y: 'Oct 13', a: 182, b: 34, c: 4 },
            { y: 'Oct 14', a: 186, b: 39, c: 9 },
            { y: 'Oct 15', a: 194, b: 40, c: 4 },
            { y: 'Oct 16', a: 196, b: 41, c: 1 }
        ],
        xkey: 'y',
        ykeys: ['a', 'b', 'c'],
        labels: ['Pulsa', 'Aksesoris', 'Handphone'],
    ...
    /* EMD Line dashboard chart */
     /* Line dashboard chart 2 */
    Morris.Line({
      element: 'dashboard-line-2',
      data: [
        { y: '2014-10-10', a: 2,b: 4,c: (2+1)},
        { y: '2014-10-11', a: 4,b: 6,c: (4+1)},
        { y: '2014-10-12', a: 7,b: 10,c: (7+1)},
        { y: '2014-10-13', a: 5,b: 7,c: (5+1)},
        { y: '2014-10-14', a: 6,b: 9,c: (6+1)},
        { y: '2014-10-15', a: 9,b: 12,c: (9+1)},
        { y: '2014-10-16', a: 18,b: 20,c: (18+1)}
      ],
      xkey: 'y',
      ykeys: ['a','b','c'],
      labels: ['Pulsa','Aksesoris','Handphone'],
      ...
      xLabels: 'day',
      gridTextSize: '10px',
      lineColors: ['#1caf9a','#33414E','#FEA223'],
      gridLineColor: '#E5E5E5'
    });   
    /* EMD Line dashboard chart 2 */
    /* Moris Area Chart */
      Morris.Area({
