        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-title">Report</li>
                    <li class="active">
                        <a href="index.html"><span class="fa fa-desktop"></span> <span class="xn-text">Overview</span></a>
                    </li>
                    <li class=" ">
                        <a href="index.html"><span class="fa fa-bar-chart-o"></span> <span class="xn-text">Performance</span></a>
                    </li>
                    <li class=" ">
                        <a href="index.html"><span class="fa fa-pencil-square-o"></span> <span class="xn-text">Plan</span></a>
                    </li>
                    <li class="xn-title">Transaction</li>
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-pencil"></span> <span class="xn-text">Transaction IN</span></a>
                        <ul>
                            <li><a href="form-elements.html"><span class="fa fa-file-text-o"></span> Served Transaction</a></li>
                            <li><a href="form-validation.html"><span class="fa fa-list-alt"></span> Not Served Transaction</a></li>
                        </ul>
                    </li>
                    <li class=" ">
                        <a href="index.html"><span class="fa fa-magic"></span> <span class="xn-text">Transaction OUT</span></a>
                    </li>
                    <li class="xn-title">Master Data</li>
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-cogs"></span> <span class="xn-text">Data Barang</span></a>                        
                        <ul>
                            <li><a href="ui-widgets.html"><span class="fa fa-heart"></span> Pulsa</a></li>                            
                            <li><a href="ui-elements.html"><span class="fa fa-cogs"></span> Aksesoris HP</a></li>
                            <li>
                                <a href="form-layouts-two-column.html"><span class="fa fa-tasks"></span> Handphone</a>
                                <div class="informer informer-danger">New</div>
                                <ul>
                                    <li><a href="form-layouts-one-column.html"><span class="fa fa-align-justify"></span> Baru</a></li>
                                    <li><a href="form-layouts-two-column.html"><span class="fa fa-th-large"></span> Bekas</a></li>
                                </ul> 
                            </li>
                            <!-- <li><a href="form-wizards.html"><span class="fa fa-arrow-right"></span> Pulsa</a></li> -->
                        </ul>
                    </li>                    
                    <li class="xn-openable">
                        ...
                        <ul>
                            <li>
                                <a href="form-layouts-two-column.html"><span class="fa fa-users"></span> User Data</a>
                                <div class="informer informer-danger">admin</div>                                
                            </li>
                            <li><a href="form-elements.html"><span class="fa fa-file-text-o"></span> U A C</a></li>
                        </ul>
                    </li>
                </ul>
                <!-- END X-NAVIGATION -->
